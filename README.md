## Geocortex Workflow Geometry Conversion Activities

This activity pack contains Geocortex Workflow activities related to conversion of ArcGIS geometries to other formats.
